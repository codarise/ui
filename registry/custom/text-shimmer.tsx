...
export function TextShimmer({
  ...
  // Detect dark mode and update styles accordingly
  useEffect(() => {
    ...
    // Build gradient strings using dynamicSpread
    ...
    el.style.backgroundImage = `${shimmerBg}, ${baseGradient}`;
  ...
  }, [shimmer, duration, variant, colors, dynamicSpread]);
